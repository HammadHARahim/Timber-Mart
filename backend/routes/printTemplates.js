 ...
 */
router.get('/', authenticateToken, checkPermission('template:view'), asyncHandler(async (req, res) => {
 ...
 * Get template by ID
 */
router.get('/:id', authenticateToken, checkPermission('template:view'), asyncHandler(async (req, res) => {
 ...
 * Create new template
 */
router.post('/', authenticateToken, checkPermission('template:create'), asyncHandler(async (req, res) => {
 ...
 * Update template
 */
router.put('/:id', authenticateToken, checkPermission('template:edit'), asyncHandler(async (req, res) => {
 ...
 * Delete template
 */
router.delete('/:id', authenticateToken, checkPermission('template:delete'), asyncHandler(async (req, res) => {
 ...
 */
router.patch('/:id/set-default', authenticateToken, checkPermission('template:edit'), asyncHandler(async (req, res) => {
 ...
 * Duplicate template
 */
router.post('/:id/duplicate', authenticateToken, checkPermission('template:create'), asyncHandler(async (req, res) => {
